    ...
    return (function (e) {
        ...
        function (e, t, n) {
            ...
            class i {
                ...
                addConnection(e, t, n, i) {
                    ...
                    if (s === this.getModuleFromNodeId(t)) {
                        var o = this.getNodeFromId(e),
                            l = !1;
                            /* ajuste 20-05-2022 - não relacionar se não ouver conexoes disponiveis */
                            if(!o.outputs[n]){
                                console.log("\r\nDrawFlow, não há relacionamento (output) disponível para este ítem: " + o.name + ' id: ' + o.id );
                                return;
                            }
                ...
                async addNode(e, t, n, i, s, o, l, c, d = !1,id) {
                    return new Promise( async (resolve, reject) => {    
                        if (this.useuuid) var a = await this.getUuid();
                        else a = this.nodeId;
                        ...
                        if ((_.classList.add("drawflow_content_node"), !1 === d)) _.innerHTML = c;
                            ...
                            this.render.createApp({ parent: this.parent, render: (e) => this.render.h(this.noderegister[c].html, this.noderegister[c].props, this.noderegister[c].options) }).mount(_);
                        } else {
                        ...
                        Object.entries(l).forEach(function (e, t) {
                            ...
                            else for (var n = _.querySelectorAll("[df-" + e[0] + "]"), i = 0; i < n.length; i++) n[i].value = e[1];
                        }),
                            h.appendChild(u),
                            h.appendChild(_),
                            h.appendChild(p),
                        ...
                        resolve((this.drawflow.drawflow[this.module].data[a] = w), this.dispatch("nodeCreated", a), this.useuuid || this.nodeId++, a);
                ...
                addNodeImport(e, t) {
                    ...
                    if ((c.classList.add("drawflow_content_node"), !1 === e.typenode)) c.innerHTML = e.html;
                        ...
                        this.render.createApp({ parent: this.parent, render: (t) => this.render.h(this.noderegister[e.html].html, this.noderegister[e.html].props, this.noderegister[e.html].options) }).mount(c);
                    } else {
                    ...
                    Object.entries(e.data).forEach(function (t, n) {
                        ...
                        else for (var i = c.querySelectorAll("[df-" + t[0] + "]"), s = 0; s < i.length; s++) i[s].value = t[1];
                    }),
                        i.appendChild(s),
                        i.appendChild(c),
                        i.appendChild(o),
                ...
                updateNodeDataFromId(e, t) {
                    ...
                    if (((this.drawflow.drawflow[n].data[e].data = t), this.module === n)) {
                        ...
                        Object.entries(t).forEach(function (e, i) {
                            ...
                            else for (var s = n.querySelectorAll("[df-" + e[0] + "]"), o = 0; o < s.length; o++) s[o].value = e[1];
                        });
                    }
                }
                addNodeInput(e) {
                ...
                getUuid(customId) {
                    return new Promise( async (resolve, reject) => {
                        ...
                        if(!customId){
                            ...
                            resolve((e[14] = "4"), (e[19] = "0123456789abcdef".substr((3 & e[19]) | 8, 1)), (e[8] = e[13] = e[18] = e[23] = "-"), e.join(""));
                            return;

                        }else{
                            this.useuuid = customId;
                            resolve(customId);
                            return ;
                        }
