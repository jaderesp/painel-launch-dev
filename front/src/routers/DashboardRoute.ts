...
router.post('/dashboard/newsClientsbyReseller', authenticateToken, DashboardController.getTotalNewClientsByReseller);
...
router.post('/dashboard/totalNewClients', authenticateToken, DashboardController.getTotalNewActiveClients);
